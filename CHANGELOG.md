...
* chore: save last release version for recovery [skip ci] ([302132d](https://github.com/UnicoLab/keras-data-processor/commit/302132d))
* fix: repo maintenance update n40nk0 (#38) ([5f79944](https://github.com/UnicoLab/keras-data-processor/commit/5f79944)), closes [#38](https://github.com/UnicoLab/keras-data-processor/issues/38)
* fix(KDP): build the transformer block, and make the documented API real ([3193f3b](https://github.com/UnicoLab/keras-data-processor/commit/3193f3b))
* fix(KDP): compute the statistics from the right rows, at the right precision ([a76c574](https://github.com/UnicoLab/keras-data-processor/commit/a76c574))
* fix(KDP): deliver the embedding and Feature-MoE options that were discarded ([97cc77e](https://github.com/UnicoLab/keras-data-processor/commit/97cc77e))
* fix(KDP): dict-mode Feature MoE survives a save/load round trip ([ea95742](https://github.com/UnicoLab/keras-data-processor/commit/ea95742))
* fix(KDP): end generated API docs with one newline, not two ([7e7aa19](https://github.com/UnicoLab/keras-data-processor/commit/7e7aa19))
* fix(KDP): fill gaps at the ends of a series and name the inert options ([e22b654](https://github.com/UnicoLab/keras-data-processor/commit/e22b654))
* fix(KDP): honour preferred_distribution however it is spelled ([e4a5b7e](https://github.com/UnicoLab/keras-data-processor/commit/e4a5b7e))
* fix(KDP): let MissingValueHandlerLayer see NaN, and showcase the direct-use layers ([64d2abe](https://github.com/UnicoLab/keras-data-processor/commit/64d2abe))
* fix(KDP): make auto_configure work without features_specs, as documented ([30f86d1](https://github.com/UnicoLab/keras-data-processor/commit/30f86d1)), closes [hi#cardinality](https://github.com/hi/issues/cardinality)
* fix(KDP): make AutoLagSelectionLayer work with its default settings ([7c37096](https://github.com/UnicoLab/keras-data-processor/commit/7c37096))
* fix(KDP): make Feature MoE routing independent of the batch ([0f3ca9f](https://github.com/UnicoLab/keras-data-processor/commit/0f3ca9f))
* fix(KDP): make feature_moe_sparsity real and report expert assignments ([a84b82f](https://github.com/UnicoLab/keras-data-processor/commit/a84b82f))
* fix(KDP): make min-max scale onto the range it is given ([883ded3](https://github.com/UnicoLab/keras-data-processor/commit/883ded3))
* fix(KDP): make text output modes reachable and correct the date/text docs ([d9917f2](https://github.com/UnicoLab/keras-data-processor/commit/d9917f2))
* fix(KDP): make the documented examples run, and fix what running them exposed ([32f0e30](https://github.com/UnicoLab/keras-data-processor/commit/32f0e30))
* fix(KDP): make the saved model, the calendar feature and tsfresh work ([ac6bd85](https://github.com/UnicoLab/keras-data-processor/commit/ac6bd85))
* fix(KDP): one DistributionType, and stop publishing docs for deleted classes ([14e9bd5](https://github.com/UnicoLab/keras-data-processor/commit/14e9bd5))
* fix(KDP): pad the features add_feature_moe_to_model stacks ([67c84c3](https://github.com/UnicoLab/keras-data-processor/commit/67c84c3))
* fix(KDP): put the output columns in the order the features were declared ([7cb956f](https://github.com/UnicoLab/keras-data-processor/commit/7cb956f))
* fix(KDP): read the season from the month, not the cosine of the year ([d532c2c](https://github.com/UnicoLab/keras-data-processor/commit/d532c2c))
* fix(KDP): reject option values that silently disabled the feature they name ([820be2c](https://github.com/UnicoLab/keras-data-processor/commit/820be2c))
* fix(KDP): repair four feature-level options that could not work ([4f3e4ea](https://github.com/UnicoLab/keras-data-processor/commit/4f3e4ea))
* fix(KDP): repair generate_multi_step_forecast and cover the advisor branches ([3d29c43](https://github.com/UnicoLab/keras-data-processor/commit/3d29c43))
* fix(KDP): repair options that were accepted and never did what they said ([11085c1](https://github.com/UnicoLab/keras-data-processor/commit/11085c1))
* fix(KDP): repair silent data defects in seasons, time series options and serialization (#37) ([3e8616a](https://github.com/UnicoLab/keras-data-processor/commit/3e8616a)), closes [#37](https://github.com/UnicoLab/keras-data-processor/issues/37)
* fix(KDP): repair three time series options and the widths they report ([1fb8a30](https://github.com/UnicoLab/keras-data-processor/commit/1fb8a30))
* fix(KDP): repair week_of_year and the clock components of CalendarFeatureLayer ([3554af0](https://github.com/UnicoLab/keras-data-processor/commit/3554af0))
* fix(KDP): report an empty categorical vocabulary and read every lag channel ([83eb49a](https://github.com/UnicoLab/keras-data-processor/commit/83eb49a))
* fix(KDP): route real features through the mixture, not arbitrary slices ([faf2c15](https://github.com/UnicoLab/keras-data-processor/commit/faf2c15))
* fix(KDP): stop predefined MoE routing silently erasing unassigned features ([73a9646](https://github.com/UnicoLab/keras-data-processor/commit/73a9646))
* fix(KDP): stop tests leaking a stats file into the working directory ([2e10d69](https://github.com/UnicoLab/keras-data-processor/commit/2e10d69))
* fix(KDP): stop TextPreprocessingLayer writing a config it cannot read back ([d702b02](https://github.com/UnicoLab/keras-data-processor/commit/d702b02))
* fix(KDP): stop the generated snippet writing options the feature ignores ([f82d96a](https://github.com/UnicoLab/keras-data-processor/commit/f82d96a))
* fix(KDP): stop two layer tests racing over one file name in the working directory ([585e366](https://github.com/UnicoLab/keras-data-processor/commit/585e366))
* test(KDP): cover value fidelity and serialization, and pin a MoE dict-mode defect ([20a557e](https://github.com/UnicoLab/keras-data-processor/commit/20a557e))
* test(KDP): hold layer options to their own evidence in the dead-option guard ([f381a6f](https://github.com/UnicoLab/keras-data-processor/commit/f381a6f))
* test(KDP): make the two assertion-free tests actually assert ([baf89af](https://github.com/UnicoLab/keras-data-processor/commit/baf89af))
* test(KDP): probe the MoE reachability check with several values, not one ([972b859](https://github.com/UnicoLab/keras-data-processor/commit/972b859))
* test(KDP): split the time series tests that mixed calendar with numeric configs ([e75a84e](https://github.com/UnicoLab/keras-data-processor/commit/e75a84e))
* docs(KDP): correct the numeric and passthrough pages, and run the examples in CI ([2fa3f84](https://github.com/UnicoLab/keras-data-processor/commit/2fa3f84))
* docs(KDP): publish the API reference and guard the docs against the code ([ec335a3](https://github.com/UnicoLab/keras-data-processor/commit/ec335a3))
* docs(KDP): publish the API reference for the mixture of experts and the advisor ([60a8997](https://github.com/UnicoLab/keras-data-processor/commit/60a8997))
* docs(KDP): rewrite the categorical and distribution-aware pages against the code ([99c0a9f](https://github.com/UnicoLab/keras-data-processor/commit/99c0a9f))
* docs(KDP): say what the time series section covers ([c2cf4cc](https://github.com/UnicoLab/keras-data-processor/commit/c2cf4cc))
* docs(KDP): state the output width tabular attention produces ([9ecc4c7](https://github.com/UnicoLab/keras-data-processor/commit/9ecc4c7))
* docs(KDP): stop four examples asking one column to be a date and a number ([02d1a09](https://github.com/UnicoLab/keras-data-processor/commit/02d1a09))
* docs(KDP): unpack what load_model returns, and guard the pattern ([0f1cb93](https://github.com/UnicoLab/keras-data-processor/commit/0f1cb93))
* feat(KDP): feature importances rank features, and doc examples get called ([a935051](https://github.com/UnicoLab/keras-data-processor/commit/a935051))
* style(KDP): format the new PerFeatureDense tests ([b4602e7](https://github.com/UnicoLab/keras-data-processor/commit/b4602e7))
* maint(KDP): keep the example scripts out of the repository root ([cb57b07](https://github.com/UnicoLab/keras-data-processor/commit/cb57b07))
* refactor(KDP): remove unreachable code and cover the auto transform ([2a38f25](https://github.com/UnicoLab/keras-data-processor/commit/2a38f25))

## 1.12.0 (2026-08-27)

* fix(KDP): correct distribution transforms, dynamic pipeline and distribution hints ([9f73c70](https://github.com/UnicoLab/keras-data-processor/commit/9f73c70))
* fix(KDP): make saved preprocessing models reloadable ([bf6bb16](https://github.com/UnicoLab/keras-data-processor/commit/bf6bb16))
* fix(KDP): make the docstring documentation generator run ([cd90054](https://github.com/UnicoLab/keras-data-processor/commit/cd90054))
* fix(KDP): make the standalone entry points work ([112ed4e](https://github.com/UnicoLab/keras-data-processor/commit/112ed4e))
* fix(KDP): only compute dataset statistics when a feature needs them ([10dcc5b](https://github.com/UnicoLab/keras-data-processor/commit/10dcc5b))
* fix(KDP): reject vocabulary statistics written by older releases ([7ecce75](https://github.com/UnicoLab/keras-data-processor/commit/7ecce75))
* fix(KDP): repair core defects, enable the linter and move to the Keras 3 API (#36) ([053c72d](https://github.com/UnicoLab/keras-data-processor/commit/053c72d)), closes [#36](https://github.com/UnicoLab/keras-data-processor/issues/36)
* fix(KDP): repair custom pipelines, inference conversion and the examples ([ac836dc](https://github.com/UnicoLab/keras-data-processor/commit/ac836dc))
* fix(KDP): repair four defects that only appeared when the model was called ([f0c1850](https://github.com/UnicoLab/keras-data-processor/commit/f0c1850)), closes [passthrou#excluded](https://github.com/passthrou/issues/excluded)
* fix(KDP): time series layers returned canned values instead of computing ([f584849](https://github.com/UnicoLab/keras-data-processor/commit/f584849))
* docs(KDP): add an upgrade guide for the 1.11.x transition ([9daadf3](https://github.com/UnicoLab/keras-data-processor/commit/9daadf3))
* docs(KDP): add Discord community link to README for user engagement ([4fc132d](https://github.com/UnicoLab/keras-data-processor/commit/4fc132d))
* docs(KDP): document the remaining public API and reach a clean lint gate ([ddfc62e](https://github.com/UnicoLab/keras-data-processor/commit/ddfc62e))
* docs(KDP): remove outdated badge links and streamline README content ([bfc4f5b](https://github.com/UnicoLab/keras-data-processor/commit/bfc4f5b))
* docs(KDP): update Discord community link in README for improved user access ([692fb24](https://github.com/UnicoLab/keras-data-processor/commit/692fb24))
* docs(KDP): update installation instructions in README to use 'kdp' instead of 'keras-data-processor' ([4966d86](https://github.com/UnicoLab/keras-data-processor/commit/4966d86))
* ci(KDP): fix release conditions, docs build and workflow dependencies ([f6ded58](https://github.com/UnicoLab/keras-data-processor/commit/f6ded58))
* ci(KDP): guard Keras 3 forward compatibility ([8adeeca](https://github.com/UnicoLab/keras-data-processor/commit/8adeeca))
* refactor(KDP): clear the lint backlog the disabled config had hidden ([22b601c](https://github.com/UnicoLab/keras-data-processor/commit/22b601c))
* refactor(KDP): target the Keras 3 API directly and fix what that exposed ([ed8d1e3](https://github.com/UnicoLab/keras-data-processor/commit/ed8d1e3))
* refactor(KDP): update repository links and branding to reflect UnicoLab ownership ([fcf82b9](https://github.com/UnicoLab/keras-data-processor/commit/fcf82b9))
* build(KDP): fix packaging metadata, docs links and destructive Makefile ([113498c](https://github.com/UnicoLab/keras-data-processor/commit/113498c))
* build(KDP): make the linter actually run ([6c38fb0](https://github.com/UnicoLab/keras-data-processor/commit/6c38fb0))
* chore: save last release version for recovery [skip ci] ([933d411](https://github.com/UnicoLab/keras-data-processor/commit/933d411))
