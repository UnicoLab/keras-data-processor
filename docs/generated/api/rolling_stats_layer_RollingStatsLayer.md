...
### Parameters- **window_size**: Size of the rolling window
...
```python
__init__(self, window_size, statistics, window_stride=1, drop_na=True, pad_value=0.0, keep_original=False, **kwargs)
```
...
### Parameters- **inputs**: Input tensor of shape ``(time_steps,)`` or
