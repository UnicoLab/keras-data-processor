...
### Parameters- **num_features**: Number of frequency features to extract (default: 5)
...
```python
__init__(self, num_features=5, feature_type='power', window_function='hann', keep_original=True, normalize=True, **kwargs)
```
