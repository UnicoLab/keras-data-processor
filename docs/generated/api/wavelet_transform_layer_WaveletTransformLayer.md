...
### Parameters- **levels**: Number of decomposition levels (default: 3)
...
```python
__init__(self, levels=3, keep_levels='all', window_sizes=None, flatten_output=True, drop_na=True, **kwargs)
```
