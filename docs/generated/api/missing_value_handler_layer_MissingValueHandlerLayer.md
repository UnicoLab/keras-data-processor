...
### Parameters- **mask_value**: Value used to indicate missing values (default: 0.0)
...
```python
__init__(self, mask_value=0.0, strategy='forward_fill', window_size=5, seasonal_period=7, add_indicators=True, extrapolate=True, **kwargs)
```
