...
```python
__init__(self, axis=1, name='unstack_features', trainable=True, dtype=None, **kwargs)
```

Initialize the layer.

### Parameters- **axis**: Axis to unstack along
...
```python
call(self, inputs) -> list
```

Unstack features along specified axis.

### Parameters- **inputs**: Tensor to unstack
...
### Parameters- **input_shape**: Input shape
