...
### Parameters- **lag_indices**: List of integers indicating the lag steps to create.
...
```python
__init__(self, lag_indices, drop_na=True, fill_value=0.0, keep_original=False, **kwargs)
```
...
### Parameters- **inputs**: Input tensor of shape (batch_size, ...) or (batch_size, time_steps)
