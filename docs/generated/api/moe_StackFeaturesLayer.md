...
```python
__init__(self, name='stack_features', trainable=True, dtype=None, **kwargs)
```
...
### Parameters- **inputs**: List of feature tensors of shape [batch_size, feature_dim]
...
### Parameters- **input_shape**: List of input shapes
