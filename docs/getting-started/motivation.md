...
<div class="contribute-container">
  ...
  <div class="contribute-cards">
    <div class="contribute-card">
      ...
      <p>Star our repository and spread the word</p>
    </div>

    <div class="contribute-card">
      <span class="contribute-icon">🐛</span>
      <p>Report issues when you find them</p>
    </div>

    <div class="contribute-card">
      <span class="contribute-icon">🔧</span>
      <p>Contribute improvements and extensions</p>
    </div>

    <div class="contribute-card">
      <span class="contribute-icon">💡</span>
      <p>Share your success stories</p>
    </div>
  </div>
...
<div class="next-steps-container">
  <a href="quick-start.md" class="next-step-card">
    ...
    <div class="next-step-content">
      ...
      <p>See KDP in action with minimal code</p>
    </div>
  </a>
  ...
  <a href="../optimization/tabular-optimization.md" class="next-step-card">
    ...
    <div class="next-step-content">
      ...
      <p>Understand the optimizations in detail</p>
    </div>
  </a>
  ...
  <a href="../examples/complex-examples.md" class="next-step-card">
    ...
    <div class="next-step-content">
      ...
      <p>See how KDP handles sophisticated scenarios</p>
    </div>
  </a>
</div>
